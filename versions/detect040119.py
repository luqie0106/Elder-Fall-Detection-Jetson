...
while True:
    ...
    if results.keypoints is not None:
        ...
        for person in filtered_people:
            ...
            non_fall_posture_like = posture == "vertical" and (sitting_like or half_squat_like or kneeling_like or standing_support_like)
            ...
            if (apply_uptilt_strict or high_uptilt_mode) and is_fall_event and not (head_feet_close or horizontal_relax_ok):
                is_fall_event = False
            ...
            if (lower_body_ok or horizontal_relax_ok) and not non_fall_posture_like:
                ...
                if low_center_like and (posture == "horizontal" or horizontal_relax_ok):
                ...
                state["fall_confirm"] = 0
                if posture == "horizontal" and horizontal_relax_ok and not non_fall_posture_like and not on_object:
                    state["ground_timer"] += 1
                    if state["ground_timer"] > required_ground_frames and state["fall_state"] != "FALLEN":
                        state["fall_state"] = "FALLEN"
                        state["fall_timer"] = FALL_HOLD_TIME
            ...
            if state["fall_state"] == "FALLEN":
                ...
                if posture == "horizontal" and (head_feet_close or horizontal_relax_ok) and not sitting_like and not on_object:
                    state["fall_timer"] = FALL_HOLD_TIME
